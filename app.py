...
st.set_page_config(page_title='Automatic ML Algorithm Comparison',
    layout='wide')
#---------------------------------#
# Model building
def build_model(df):
...
#---------------------------------#
st.write("""
# AUTOMATIC ML Algorithm Comparison 

 **lazypredict** library is used for building several machine learning models at once.
...
if uploaded_file is not None:
    ...
    if st.button('Press to use Example Dataset'):
        ...
        st.markdown('Example dataset = Boston Housing Dataset.')
        st.write(df.head(5))
